...
[Link to Problem on GFG](https://www.geeksforgeeks.org/problems/fractional-knapsack-1587115620/1)
...
* **Greedy Algorithm (Sort by value/weight ratio):**
  ...
  1. Compute ratio = `val[i] / wt[i]` for each item.  
...
* **Why This Works:**  
  ...
  Fractional knapsack is always optimally solvable by greedy.
